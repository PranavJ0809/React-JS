...
export default function Card() {
    return (
        ...
        dark:bg-gray-800 dark:border-gray-700" // IMP
        >
            <a href="/">
            ...
            <div className="px-5 pb-5">
                ...
                <div className="flex items-center mt-2.5 mb-5">
                    ...
                    {/* For 1 empty star  */}
                    <svg className="w-4 h-4 text-gray-200 
                    dark:text-gray-600" // IMP
                    ...
                    dark:bg-blue-200 dark:text-blue-800 ml-3" // IMP
                    >
                        4.0
                    </span>
                </div>
                ...
                <div className="flex items-center justify-between">
                    ...
                    <a
                        ...
                        dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800" // IMP
                    >
                        Add to cart
                    </a>
                </div>
